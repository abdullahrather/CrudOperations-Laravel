...
@section('main-container')
    <!-- Page Header-->
    <header class="masthead" style="background-image: url({{ url('frontend/assets/img/contact-bg.jpg') }})">
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="my-5">
                        ...
                        <div class="form-floating">
                            ...
                            <div class="invalid-feedback" data-sb-feedback="message:required">Please select a country.</div>
                        </div>
                        <div class="form-floating">
